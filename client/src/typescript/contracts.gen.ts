...
export function setupWorld(provider: DojoProvider) {
	...
	const build_actions_gameEnd_calldata = (boardId: BigNumberish, result: BigNumberish, timeElapsed: BigNumberish, currencyAmount: BigNumberish) => {
		return {
			contractName: "actions",
			entrypoint: "gameEnd",
	...
	const actions_gameEnd = async (snAccount: Account | AccountInterface, boardId: BigNumberish, result: BigNumberish, timeElapsed: BigNumberish, currencyAmount: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
